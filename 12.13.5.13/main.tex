...
Q: It is known that 10\% of certain articles manufactured are defective. What is the probability that in a random sample of 12 such articles, 9 are defective?
\\ \solution:
\begin{table}[h!]
 \begin{center}
    \begin{tabular}{|l|c|r|}
...
\end{table}
    ...
    Since the $X_i$ are IID, the pmf of $Y$ is given by
    \begin{align}
